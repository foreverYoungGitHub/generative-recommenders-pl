...
# # with open('/Users/yangliu/Downloads/saved_data.pkl', "rb") as f:
# #     data = pickle.load(f)
# data = torch.load('/Users/yangliu/Downloads/saved_data.pkl', map_location='cpu')
# metric = RetrievalMetrics(k=100, at_k_list=[1, 10, 50, 100, 200])
# metric.update(data["eval_top_k_ids"], torch.tensor([[2987]]))
# output = metric.compute()
# print(output)
